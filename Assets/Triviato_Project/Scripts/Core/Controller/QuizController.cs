...
public class QuizController : MonoBehaviour
{
    ...
    [SerializeField] private int numberOfQuestionsToUse = 10;
    ...
    {
        stateManager.Initialize(quizData, numberOfQuestionsToUse);
    ...
    private void EndQuiz()
    {
        ...
        GameManager.Instance.ShowResult(result.Passed);
    }
